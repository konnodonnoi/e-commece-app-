...
class Navbar extends React.Component {
  ...
  renderNavigationLinks() {
    let temp = (
      <NavLink
        activeClassName={"link--active , link , list , item "}
        key="home"
        to={`/home`}
      >
        Home
  ...
  renderNavbar() {
    return (
      <nav id="navbar">
        <div className="navbar_links , header">
          {this.renderNavigationLinks()}
        </div>
        {this.renderNavbarCenterIcon()}
        <div className="currency_cart , navbar_CurrencySign , wrapper">
  ...
  render() {
    return <div className="navbar_container">{this.renderNavbar()}</div>;
  }
}
